...
import './index-file-list.vue';const _hoisted_1 = { class: "file-list-background" };
const _hoisted_2 = {
  key: 0,
  class: "file-list-background-start"
};
const _hoisted_3 = {
  key: 1,
  class: "file-list-background-end"
};
const TOLERANCE = 1;
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index-file-list",
  props: {
    items: { default: () => [] },
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ref_key: "wrapperRef",
        ref: wrapperRef,
        class: normalizeClass(["file-list-wrapper", {
          "file-list-overflow-ping-start": _ctx.overflow === "scrollX" && unref(pingStart),
          "file-list-overflow-ping-end": _ctx.overflow === "scrollX" && unref(pingEnd)
        }]),
        ...
        createElementVNode("div", {
          ...
          ref: containerRef,
          class: normalizeClass(["file-list", {
            [`file-list-overflow-${_ctx.overflow}`]: _ctx.overflow
          }]),
...
const indexFileList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5f43471e"]]);
export {
  indexFileList as default
};
//# sourceMappingURL=index-file-list.js.map
