...
// node_modules/.pnpm/vue-element-plus-x@1.2.0_markdown-it@14.1.0_mermaid@11.12.0_typescript-api-pro@0.0.7_typescript@5.8.3/node_modules/vue-element-plus-x/dist/kanban-definition-NDS4AKOZ-BXT57753.js
var parser = (function() {
...
var genSections = __name((options) => {
  ...
  const adjuster = __name((color, level) => options.darkMode ? darken(color, level) : lighten(color, level), "adjuster");
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
    sections2 += `
...
//# sourceMappingURL=kanban-definition-NDS4AKOZ-BXT57753-YRIRTNRA.js.map
